# OpenPLC v3: FC16 write multiple registers by start address

**Affected:** OpenPLC v3 `webserver/core/modbus.cpp`, TCP port 502.  
**CWE:** CWE-306

Unauthenticated FC16 overwrites a block of holding registers from an attacker start address.
...
- https://github.com/APEvul-cyber/modbus_openplc_vul/tree/main/fc16_write_multiple_regs_starting_addr
